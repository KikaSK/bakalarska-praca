...
\item{
    ...
    \begin{figure}
        ...
        \caption[Triangulácia plochy konštantného súčinu vzdialeností od štvorice bodov]
        {Triangulácia plochy konštantného súčinu vzdialeností od štvorice bodov.}
        %id obrazku, pomocou ktoreho sa budeme na obrazok odvolavat
        \label{obr:blobby}
    \end{figure}
...
\begin{figure}
    \centerline{\includegraphics[width=0.8\textwidth]{images/cylinder_normal}}
...
\begin{figure}
    \centerline{\includegraphics[width=0.8\textwidth]{images/cylinder}}
...
\item{
    ...
    \begin{figure}
        ...
        \caption[Triangulácia eliptického paraboloidu]{Triangulácia eliptického paraboloidu.}
        %id obrazku, pomocou ktoreho sa budeme na obrazok odvolavat
...
\setlength{\tabcolsep}{4pt}
    ...
    V druhej tabuľke vidíme porovnanie pomeru priemernej vzdialenosti ťažiska od svojej projekcie ku 
