     ...
     \caption[TODO]{Výsledky merania}
        \begin{center}
            \begin{tabular}{|c|A B C D E F G H|}
                ...
                $\hspace{8mm} a \hspace{8mm}$ & $k_1$ & $k_2$ & $k_3$ & $k_4$ & $k_5$ & $k_6$ & $k_7$ & $k_8$ \EndTableHeader\\
                \hline
                1 & 0.0 & 0.029 & 0.912 & 0.9 & 0.629 & 0.049 & 0.802 & 0.802\\
                \hline
...
\item{
    ...
    Výsledky meriania kritérii kvality môžeme vidieť v tabuľke \ref{tab:hyperbolic_paraboloid}.
...
\item{
    ...
    Výsledky meriania kritérii kvality môžeme vidieť v tabuľke \ref{tab:parabolic_cylinder}.
...
\item{
    ...
    Výsledky meriania kritérii kvality môžeme vidieť v tabuľke \ref{tab:quadric_cone}.
...
\begin{figure}
    \centerline{\includegraphics[width=1\textwidth]{images/cut_sphere_normal}}
...
\begin{figure}
    \centerline{\includegraphics[width=1\textwidth]{images/cut_sphere}}
