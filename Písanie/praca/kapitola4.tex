...
\begin{enumerate}
    ...
    \item{
        ...
        $$b_0 = \vec{x_i x_j},$$
        $$b_1 = \vec{x_i x_k},$$
        $$b_2 = \vec{x_i x_j} \times \vec{x_i x_k}.$$

        Potom trojuholník $T(x_i, x_j, x_{new})$ je \textit{správne} orientovaný, ak je súradnicová 
        sústava $(\vec{x_i x_j}, \vec{x_i x_{new}}, \vec{x_i x_j} \times \vec{x_i x_{new}})$
        orientovaná opačne ako referenčná súradnicová sústrava. To je práve vtedy, keď platí vzťah 
...
\begin{enumerate}
    ...
    \item{
        ...
        \begin{figure}
            \centerline{\includegraphics[width=0.25\textwidth]{images/isocurves}}
